        ...
        <div className="overflow-y-auto overflow-x-hidden flex-grow">
          <div className="flex flex-col py-4 space-y-1">
            {navItems.map((item: any, key: number) => {
              return (
                <Link
                  key={key}
                  href={item.itemLink}
                  className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-indigo-50 text-gray-600 hover:text-gray-800 border-r-4 border-transparent hover:border-indigo-500 pr-6"
                >
            ...
            <li>
              <a
                href="#"
                className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-indigo-100 text-gray-600 hover:text-gray-800 border-r-4 border-transparent hover:border-indigo-500 pl-6"
              >
                <span className="inline-flex justify-center items-center ml-4">
                  <svg
                    className="w-5 h-5"
